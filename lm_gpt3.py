...
class LM_GPT3(LMSamplerBaseClass):
    def __init__(self, model_name):
        ...
        if self.engine not in ["ada", "babbage", "curie", "davinci", "text-davinci-001", "text-davinci-002" ]:
            raise ValueError("Invalid model name. Must be one of: 'ada', 'babbage', 'curie', 'davinci', 'text-davinci-001', 'text-davinci-002'")
